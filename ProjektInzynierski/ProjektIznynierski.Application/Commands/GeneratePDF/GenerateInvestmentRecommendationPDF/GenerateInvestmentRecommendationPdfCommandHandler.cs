...
{
    public class GenerateInvestmentRecommendationPdfCommandHandler : IRequestHandler<GenerateInvestmentRecommendationPdfCommand, byte[]>
    {
        ...
        public GenerateInvestmentRecommendationPdfCommandHandler(IAIAnalisisRequestRepository analysisRequestRepository, IInvestInstrumentRepository investInstrumentRepository,
            IFinancialMetricRepository financialMetricRepository,IFinancialReportRepository financialReportRepository, IInvestmentRecommendationPdfService pdfService)
        {
        ...
        public async Task<byte[]> Handle(GenerateInvestmentRecommendationPdfCommand request, CancellationToken cancellationToken)
        {
