...
const defaultTiles = [
  { key: "InvestProfile", label: "My Investment Profile", route: ROUTES.INVEST_PROFILE },
  ...
  { key: "InvestInstrument", label: "Investment Instruments", route: ROUTES.INVEST_INSTRUMENT },
  { key: "FinancialReport", label: "Financial Reports", route: ROUTES.FINANCIAL_REPORT },
